<template>
  <div class="w-full h-full flex justify-center items-center">
    <div class="flex-col w-fit h-fit">
      ...
      <v-window v-model="onboarding" class="w-fit h-fit mx-auto" dir="ltr" show-arrows>
          ...
          <div class="w-fit h-fit">
            ...
            <div class="flex w-fit h-fit">
              <ul class="w-24 sm:w-36 h-fit my-auto list-disc">
                <li v-for="(tool, index) in devTools" :key="index">{{ tool }}</li>
              </ul>
              <div class="w-36 sm:w-64 aspect-square cursor-grab flex items-center justify-center">
        ...
        <v-window-item class="w-fit px-20 mx-auto h-fit">
          <div class="w-fit h-fit">
            ...
            <div class="flex w-fit h-fit">
              <ul class="w-24 sm:w-36 h-fit my-auto list-disc">
                <li v-for="(tool, index) in designTools" :key="index">{{ tool }}</li>
              </ul>
              <div class="w-36 sm:w-64 aspect-square cursor-grab flex items-center justify-center">
                <TresCanvas shadows alpha>
                  <TresPerspectiveCamera :position="[0, 0, 15]" />
...
const devTools = ref(['HTML&CSS', 'JavaScript', 'PHP', 'Vue JS', 'Laravel', 'Tailwind CSS'])
